...
fn main() {
    ...
    // Build ripser128 (128-bit index version)
    ...
    build128
        ...
        // Even though index_t differs (int64_t vs __int128_t), many types/functions have
        // identical mangled names because index_t is a typedef (not in mangled names).
        .define("is_prime", Some("is_prime128"))
        .define("multiplicative_inverse_vector", Some("multiplicative_inverse_vector128"))
        ...
        .define("greater_diameter_or_smaller_index", Some("greater_diameter_or_smaller_index128"))
        .define("greater_diameter_or_smaller_index_comp", Some("greater_diameter_or_smaller_index_comp128"))
        ...
        .define("compressed_distance_matrix", Some("compressed_distance_matrix128"))
        .define("compressed_lower_distance_matrix", Some("compressed_lower_distance_matrix128"))
        .define("compressed_upper_distance_matrix", Some("compressed_upper_distance_matrix128"))
        .define("compressed_sparse_matrix", Some("compressed_sparse_matrix128"))
        .define("sparse_distance_matrix", Some("sparse_distance_matrix128"))
        .define("borrowed_lower_distance_matrix", Some("borrowed_lower_distance_matrix128"))
